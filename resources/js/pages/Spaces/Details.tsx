...
const Index = () => {
      ...
      <div className="min-h-screen bg-[#fff6f1]">
        <div className="container mx-auto max-w-7xl px-4 py-16">
          <div className="animate-pulse space-y-8">
            ...
            <div className="h-96 bg-[#4e2780]/20 rounded-2xl"></div>
      ...
      <>
        ...
        <div className="min-h-screen bg-[#fff6f1] flex items-center justify-center">
          <div className="text-center space-y-6 animate-fade-in">
            <h1 className="text-3xl font-bold text-[#4e2780]">Espaço não encontrado</h1>
  ...
  return (
    <div className="min-h-screen bg-[#fff6f1] flex flex-col">
      <Header />
      {/* Hero Section */}
      <section className="container mx-auto max-w-7xl px-2 sm:px-4 py-8 md:py-12">
      ...
      {/* Contact Section */}
      <section className="container mx-auto max-w-7xl px-2 sm:px-4 pb-12 md:pb-16">
      ...
      <section className="container mx-auto max-w-7xl px-2 sm:px-4 pb-8 md:pb-12">
        <div className="bg-white rounded-2xl shadow-md border-0">
          <div className="p-8 text-center space-y-6">
            <div className="text-4xl font-bold text-[#4e2780] mb-2">
              Já visitou este espaço?
            </div>
            <button
              className="w-full px-8 py-4 text-lg font-semibold rounded-xl bg-[#4e2780] text-white shadow-md hover:bg-[#3a1e5a] focus:outline-none focus:ring-2 focus:ring-[#b39ddb] focus:ring-offset-2 transition-all duration-300 flex items-center justify-center"
