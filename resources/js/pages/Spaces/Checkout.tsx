                ...
                <div className="container mx-auto max-w-6xl">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                            {plans.map((plan) => {
                                                ...
                                                return (
                                                    <div
                                                        key={plan.id}
                                                        className={`p-4 rounded-xl border-2 transition-all duration-300 cursor-pointer ${isCurrentPlan
                    ...
                    {!subscriptionStatus?.isActive && (
                        <>
                            <div className="text-center mb-10">
                                <h1 className="text-2xl sm:text-4xl font-bold text-[#4e2780] mb-4">
                                    Escolha seu Plano
                                </h1>
                    ...
                    `}
                          ...
                          ${selectedPlan === plan.id
                                                ...
                                                onClick={() => handleSelectPlan(plan.id)}
                                                aria-label={selectedPlan === plan.id ? 'Plano selecionado' : 'Selecionar plano'}
                                            >
