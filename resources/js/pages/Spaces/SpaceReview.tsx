                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                className="border-[#4e2780]/20 focus:border-[#4e2780] focus:ring-[#4e2780] rounded-xl text-[#4e2780] placeholder:text-[#4e2780]/40"
                                                required
                                            />
                                        </div>
                                        <div className="space-y-2">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <Textarea
                                        ...
                                        maxLength={500}
                                    />
                                    <div className="flex justify-between text-xs text-[#4e2780]/60">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                    <Button
                                        ...
                                        className="w-full sm:w-auto bg-[#4e2780] text-white font-semibold py-3 rounded-xl shadow-md hover:bg-[#3a1e5a] cursor-pointer transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
