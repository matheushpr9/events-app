...
const SearchSection = ({ onSearch, loading }: SearchSectionProps) => {
    ...
    return (
        <section
            className="bg-[#f4e6f3] bg-gradient-to-b from-[#f4e6f3] to-[#fff6f1] py-6 px-2 sm:px-4"
            aria-label="Seção de busca de espaços"
        >
            <div className="container mx-auto max-w-6xl">
                {/* Hero Section */}
                <div className="text-center mb-6 animate-fade-in">
                    <h1 className="text-xl sm:text-2xl md:text-5xl font-bold text-[#4e2780] mb-2 md:mb-6 leading-tight">
                        Seu evento em um clique!
                    </h1>
                    <p className="text-sm sm:text-base md:text-xl text-[#4e2780]/70 max-w-3xl mx-auto leading-relaxed">
                        Encontre espaços únicos e especiais para transformar seu evento em uma experiência inesquecível
                    </p>
                </div>

                {/* Search Card */}
                <Card className="backdrop-blur bg-white/90 shadow-lg border-0 animate-slide-up">
                    <CardContent className="p-3 sm:p-4 md:p-8">
                        ...
                        >
                            <div className="flex flex-col gap-3 md:flex-row md:gap-4">
                                ...
                                <div className="relative w-full">
                                    ...
                                    <Input
                                        ...
                                        className="pl-12 bg-white/90 border-[#4e2780]/20 text-[#4e2780] h-12 rounded-xl focus:ring-2 focus:ring-[#b39ddb] placeholder:text-[#4e2780]/50 text-base sm:text-lg"
                            ...
                            <Button
                                type="submit"
                                disabled={loading}
                                className="w-full md:w-auto bg-[#4e2780] bg-gradient-to-br from-[#4e2780] to-[#7c5ca3] text-white font-semibold px-8 h-14 rounded-xl hover:shadow-lg transition-all duration-300 disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-[#b39ddb] cursor-pointer text-lg"
                        ...
                        <div className="border-t border-[#4e2780]/10 pt-3 md:pt-6">
                            <button
                                type="button"
                                onClick={() => setShowAdvanced(!showAdvanced)}
                                className="flex items-center gap-3 mb-3 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[#b39ddb]"
                            ...
                            >
                                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-4 md:gap-4 animate-fade-in">
                                    <Select
                                        closeMenuOnSelect
                                        isMulti={false}
                                        isClearable
